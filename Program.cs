...
VALUES ('John Johnson','200000','Coffee Courier','000','true');
INSERT INTO “Employees” ("Full Name","Salary","Job Position","Phone Extension","Is Part Time")
VALUES ('Todd Ault','1000000','CEO','001','false');
INSERT INTO “Employees” ("Full Name","Salary","JobPosition","Phone Extension","Is Part Time")
VALUES ('Perry Williams’,‘150000’,‘CTO’,‘333’,‘false’);
INSERT INTO “Employees” ("Full Name","Salary","Job Position","Phone Extension","Is Part Time")
VALUES ('Lazy Larry’,‘25000’,‘Son of the boss’,‘444’,‘true’);
INSERT INTO “Employees” ("Full Name","Salary","Job Position","Phone Extension","Is Part Time")
VALUES ('Alex Jones’,‘70000’,‘PR Manager’,‘555’,‘false’);
INSERT INTO “Employees” ("Full Name","Salary","Job Position","Phone Extension","Is Part Time")
VALUES ('Anthony Pettis','70000','Cook','666','false');
-- Select all columns for all employees.
CompanyDatabase> SELECT * FROM “Employees”;
+----------------+----------+-----------------+------------------+--------------+
-- Select only the full names and phone extensions for only full-time employees.
SELECT "Full Name", "Phone Extension" FROM "Employees" WHERE "Is Part Time" = 'false';
